...
import api from "../../api/api"; // já deve ter configurado axios
...
export default function Header({ setCollapsed, collapsed }) {
  ...
  const handleDeleteAccount = async () => {
    const confirmDelete = window.confirm(
      "⚠️ Tem certeza que deseja excluir sua conta? Essa ação não poderá ser desfeita."
    );
  ...
  return (
    <Style_header>
      <div className="left menu">
        ...
        <h1 className="text-xl font-bold" onClick={navHome}>
          VideoBox
        </h1>
      </div>
